...
float scene_sdf(vec3 p) {
    ...
    scene = max(scene,
        box_sdf(p - vec3(0.0, 0.0, 0.0), vec3(500.0, 500.0, 500.0)));
...
void main() {
    ...
    vec3 theta = noise_vec3(100.0) * 4.0*PI;

    //ro *= rotate(theta);
    rd *= rotate(vec3(radians(10), radians(10), radians(-85)));
...
target = Texture("target", (9 * 500, 16 * 500))
